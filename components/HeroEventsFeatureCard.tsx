  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col p-4 sm:p-5">
        ...
        <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/75">Upcoming Events</p>

        <div className="relative mt-1.5 min-h-[3.25rem] flex-1" aria-live="polite">
          {upcomingEventCards.map((event, i) => (
            <div
              key={event.title}
